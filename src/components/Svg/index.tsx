...
class Svg extends React.PureComponent<Props, any> {
  public render() {
    ...
    switch (name) {
      ...
      case 'torus':
        return <svg xmlns="http://www.w3.org/2000/svg" version="1.1" id="Layer_1" x="0px" y="0px" width={size} height={size} viewBox="0 0 256 256" enableBackground="new 0 0 256 256" >  
